...
const Integration = () => {
    ...
    duration-200 cursor-not-allowed bg-white  text-gray-900 \
     border-gray-300 "

    const labelClass = 'block text-xs sm:text-sm font-medium mb-1.5 text-gray-700 ';
    ...
    return (
        <div className="min-h-screen bg-slate-50  transition-colors duration-300 pb-10">
            ...
            <motion.div
                ...
                className="flex bg-white  p-4 rounded-xl
                    shadow-sm 
                    border border-transparent 
                    mb-4 items-center transition-colors duration-200"
            >
                <ArrowLeft className="w-5 h-5 cursor-pointer flex-shrink-0 text-gray-600 " />
                <div className="ml-3">
                    <h6 className="font-bold text-lg sm:text-2xl font-sans mb-0.5 text-gray-900 ">
                        Manage Riders
                    </h6>
            ...
            >
                {statCards.map(({ label, value, icon, color }, i) => (
                    <motion.div
                        ...
                        className="border  h-24 rounded-xl shadow-sm
                            bg-white 
            ...
            {payuMsg && (
                <ReusableDialog>
                    <h3 className="font-medium text-sm text-center text-red-600 ">
                        {payuMsg}
                    </h3>
                </ReusableDialog>
            ) }
                    ...
                    <form className="w-full mt-2 space-y-4">
                        ...
                        <div className="flex gap-3">
                            <div className="flex-1">
                                ...
                                >
                                    <option value="select" className="">Select ID Type</option>
                                    <option value="driver's license" className="">Driver's License</option>
                                    <option value="national id" className="">National ID</option>
                                    <option value="voter's card" className="">Voter's Card</option>
                                    <option value="passport" className="">Passport</option>
                                </select>
                            </div>
                            <div className="flex-1">
            ...
            >
                <Container>
                    ...
                    <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 mb-3">
                        <div>
                            <h6 className="font-bold text-base sm:text-xl font-sans text-gray-900 ">
                                Riders List
                            </h6>
                            <p className="text-xs sm:text-sm text-gray-500 ">
                        ...
                        <table className="min-w-full text-sm">
                            ...
                            <tbody className="bg-white  divide-y divide-gray-100 ">
                                {filteredRiders.length === 0 ? (
                                    ...
                                    <tr key={rider.id} className="hover:bg-gray-50  transition-colors duration-150">
                                        {/* Rider */}
                                        ...
                                        <td className="py-3 px-4">
                                            {rider.status.toLowerCase() === 'busy' ? (
                                                <span className="text-xs border border-red-300  bg-red-50  rounded-full px-2.5 py-0.5 text-red-500  font-medium">
                                                    {rider.status}
                                                </span>
                                            ) : rider.status.toLowerCase() === 'inactive' ? (
                                                <span className="text-xs border border-gray-300  bg-gray-50  rounded-full px-2.5 py-0.5 text-gray-500  font-medium">
                                                    {rider.status}
                                                </span>
                                            ) : (
                                                <span className="text-xs border border-green-300  bg-green-50  rounded-full px-2.5 py-0.5 text-green-600  font-medium">
                                                    {rider.status}
                                                </span>
                                            )}
                                        </td>
                        ...
                        <ReusableDialog>
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                <div className="space-y-2">
                                    ...
                                    <p className="text-sm text-gray-900 ">{selectedRider.user.name}</p>
                                </div>
                                <div className="space-y-2">
                                    <p className="text-xs text-gray-500 ">Email</p>
                                    <p className="text-sm text-gray-900 ">{selectedRider.user.email}</p>
                                </div>
                                <div className="space-y-2">
                                    <p className="text-xs text-gray-500 ">Phone</p>
                                    <p className="text-sm text-gray-900 ">{selectedRider.user.phone_number}</p>
                                </div>
                                <div className="space-y-2">
                                    <p className="text-xs text-gray-500 ">Location</p>
                                    <p className="text-sm text-gray-900 ">{selectedRider.user.address}</p>
                                </div>
                                <div className="space-y-2">
                                    <p className="text-xs text-gray-500 ">ID Type</p>
                                    <p className="text-sm text-gray-900 ">{selectedRider.identity_card_type || 'N/A'}</p>
                                </div>
                                <div className="space-y-2">
                                    <p className="text-xs text-gray-500 ">ID Number</p>
                                    <p className="text-sm text-gray-900 ">{selectedRider.id_number || 'N/A'}</p>
                                </div>
                            </div>
                        </ReusableDialog>
                    )}
                    ...
                    {showRiderDeleteDialog && (
                        <DeleteDialog>
                            <div className="flex justify-between w-full mb-4">
                                ...
                                <button
                                    className="text-gray-400  hover:text-gray-700  transition-colors text-lg leading-none cursor-pointer ml-4"
