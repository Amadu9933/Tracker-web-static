const LandingPage: React.FC = () => {
  return (
    <div className="  md:pl-0  w-full inline-block  justify-center  items-center">
      ...
      <div className=" w-full flex gap-5   flex-col md:flex-row justify-center md:justify-evenly ">
        ...
        <div className="bg-slate-600   w-[350px] md:w-[305px] h-[180px] pt-[48px] pb-[24px] mr-0 md:mr-16 ml-6 md:px-[10px] rounded-[8px] text-center">
        ...
        <div className="bg-slate-600 w-[350px] md:w-[305px] h-[180px] pt-[48px] ml-6  pb-[24px] mr-0 md:mr-16 rounded-[8px] px-[10px] text-center">
        ...
        <div className="bg-slate-600 w-[350px] md:w-[305px] h-[180px] ml-6  pt-[48px] pb-[24px] rounded-[8px] px-[10px] text-center">
          <h1 className="font-medium text-lg text-white">
            Reliable Security
          </h1>
          <p className="text-[#B3C3CF] text-sm">
