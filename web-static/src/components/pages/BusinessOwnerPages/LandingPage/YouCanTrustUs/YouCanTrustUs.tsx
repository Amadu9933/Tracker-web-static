...
const YouCanTrustUs: React.FC = () => {
  return (
    <div className="bg-[#FFF8EF]  flex justify-center items-center py-16 px-4 md:px-8 transition-colors duration-300">
      <div className="w-full max-w-3xl text-center">
        ...
        <motion.div
          ...
          className="border-2 border-[#8E9090]  rounded-lg p-6 md:p-8 flex flex-col justify-center items-center bg-white  shadow-sm  transition-colors duration-300"
        >
