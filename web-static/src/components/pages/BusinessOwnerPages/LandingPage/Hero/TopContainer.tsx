    ...
    <div className="absolute w-[50.5%]  ">
      <div className="relative  mt-24 ">
        ...
        <div className="relative text-left py-20 pl-14">
          ...
          <p className="text-small font-normal text-[#585858]">
            Streamline your shipping process, generates unique tracking IDs for
            your parcels. Say goodbye to logistics headaches and hello to
            efficiency.
          </p>
        </div>
      </div>
