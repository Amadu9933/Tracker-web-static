...
const LoginTabComponent: React.FC = () => {
  const [selectedTab, setSelectedTab] = useState<'business' | 'logistics'>(
    'business'
  );
        ...
        <div>
          {selectedTab === 'business' ? (
            ...
            <div className="p-4 bg-gray-100 rounded shadow-md">
              ...
              <p>
                Logistics involve the detailed coordination of complex
                operations involving people, facilities, and supplies. This tab
                can include specific information or features related to
                logistics.
              </p>
            </div>
          )}
