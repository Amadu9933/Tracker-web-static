...
const LoginTabComponent: React.FC = () => {
  ...
  return (
    <div className="flex flex-col md:flex-row min-h-screen w-full border-t border-t-gray-200  bg-slate-50  text-slate-900  md:px-0">
      ...
      {/* Right: form panel */}
      <div className="w-full md:w-3/5 min-h-screen flex flex-col justify-center px-6 sm:px-12 md:px-20 lg:px-32 py-16 md:py-0 bg-white  text-slate-900 ">
