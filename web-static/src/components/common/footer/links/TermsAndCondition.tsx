  ...
  <div className="mx-auto max-w-6xl px-4 py-14 mt-16  md:px-8">
    <div className="overflow-hidden rounded-[28px] border border-slate-200 bg-white shadow-sm">
      ...
      <div className="space-y-6 px-6 py-8 text-sm leading-7 text-slate-700 md:px-10">
        <p>
          TrackerrGo is a real-time parcel tracking platform designed to provide
          visibility for business owners managing their logistics operations.
        </p>

        <p>
          Business owners onboard and manage their own riders. TrackerrGo does not
          employ, compensate, or supervise riders, as they are independently
          owned and managed by their respective vendors.
        </p>

        <p>
          TrackerrGo is not liable for the safety, loss, delay, or damage of any
        ...
        <div className="rounded-2xl border border-slate-200 bg-slate-50 p-5">
          ...
          <p>
            TrackerrGo respects your privacy and only collects information necessary
        ...
        <div className="rounded-2xl border border-orange-100 bg-orange-50 p-5">
          ...
          <p>
            By continuing to use TrackerrGo, you confirm that you have read,
