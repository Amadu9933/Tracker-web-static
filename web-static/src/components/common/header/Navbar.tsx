...
const Navbar: React.FC = () => {
	return (
		<nav className="flex justify-between items-center px-20 py-6 font-medium text-md border-neutral-400  border ">
			<div className="text-2xl font-bold ">
				<img src={logo} alt="Logo" className="nav-logo" />
			</div>
			<div className="flex text-neutral-400  h-9">
				...
				<div className="rounded flex py-2 px-4 border-neutral-400  border mt-0">
