...
const App = () => {
    ...
    socket.onmessage = (event) => {
      ...
      if (location) {
        ...
        if (
          ...
          fetch(
            `https://roads.googleapis.com/v1/snapToRoads?path=${rider_lat},${rider_lng}&key=AIzaSyAMYxNgIQ6zjpOE_xhhdJNjlqHMYeGLfO4`
          )
            .then((res) => res.json())
            .then((data) => {
  ...
  return (
    <APIProvider apiKey={"AIzaSyAMYxNgIQ6zjpOE_xhhdJNjlqHMYeGLfO4"}>
      <div
        style={{
